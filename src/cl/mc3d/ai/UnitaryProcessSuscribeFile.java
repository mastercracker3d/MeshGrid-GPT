...
import cl.mc3d.gpt4all.LLModel.Messages;
import cl.mc3d.gpt4all.LLModel.PromptMessage;
import java.io.File;
...
public class UnitaryProcessSuscribeFile implements Runnable {
    ...
    public UnitaryProcessSuscribeFile(String locationStart, TextArea logTextArea, IgniteCache igniteCache, String cacheName, LLModel model, LLModel.GenerationConfig config, String modelPromptTemplate, String cipherMessage, String keyStorePass) {
